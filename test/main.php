...
return array(
	...
	'components'=>array(
                'user'=>array(
                    ...
                    'identityCookie' => array('domain' => '.salonchimp.com'),
		...
		'urlManager'=>array(
			...
			'rules'=>array(
				...
				'http://<user:\w+>.salonchimp.com/<controller:\w+>/<id:\d+>/'=>'<controller>/view',
				'http://<user:\w+>.salonchimp.com/<controller:\w+>/<action:\w+>/<id:\d+>/'=>'<controller>/<action>',
				'http://<user:\w+>.salonchimp.com/<controller:\w+>/<action:\w+>'=>'<controller>/<action>',      
                               /* 
                ...
                'session' => array(
                        ...
                        'cookieParams' => array('domain' => '.salonchimp.com'),
                        'timeout' => 3600,
                        'sessionName' => 'session',
                     ),
