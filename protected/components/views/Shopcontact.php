...
?>
	...
	<div class="row ">
    <?php $model->body = 'Comment/Remark'?>
		<?php echo $form->textArea($model,'body',array('value'=>'Comment/Remark','id'=>'msgbox', 'onblur'=>"if(this.value==''){this.value='Comment/Remark'}", 'onclick'=>"if(this.value=='Comment/Remark'){this.value=''}")); ?>
                <?php echo $form->error($model,'body'); ?>
	</div>
	 <input type="hidden" name="merchant" id="merchant-id" value="<?php echo $merchant; ?>"/>
